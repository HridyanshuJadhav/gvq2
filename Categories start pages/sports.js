...
function sports_level1_submit() {
  ...
  if (sports_result < 3) {
    document.getElementById("sports_level1_nextlevel").disabled = true;
    document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
   }
   if (sports_result >= 3) {
      document.getElementById("sports_level1_nextlevel").disabled = false;
     document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_result + "out of 7. You passed the level. You can go to the next level.";
...
function sports_level2_submit() {
  ...
  if (sports_result < 3) {
    document.getElementById("sports_level2_nextlevel").disabled = true;
    document.getElementById("sports_level2_result").innerHTML = "Your score is "+ sports_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
  }
 if (sports_result >= 3) {
    document.getElementById("sports_level2_nextlevel").disabled = false;
    document.getElementById("sports_level2_result").innerHTML = "Your score is "+ sports_result + "out of 7. You passed the level. You can go to the next level.";
  }
