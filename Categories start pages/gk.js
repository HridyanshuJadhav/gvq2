...
// document.getElementById("gk_level2_nextlevel").disabled = true;
...
//   gk_result = gk_l1_result;

//   if (gk_l1_result < 3) {
//     document.getElementById("gk_level1_nextlevel").disabled = true;
//     document.getElementById("gk_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + gk_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + gk_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
//   }
//   if (gk_l1_result >= 3) {
//     document.getElementById("gk_level1_nextlevel").disabled = false;
//     document.getElementById("gk_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + gk_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + gk_result + "</b> out of 21. You passed the level. You can go to the next level.";
//   }
// }

// function gk_level1_reset(){
//   for (let i = 1; i <= 21; i++) {
//     for (let j = 1; j <= 4; j++) {
//       document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
//     }
//   };
//   document.getElementById("gk_level1_result").innerHTML = " ";
...
// function gk_level1_save(){

// }

// function gk_level1_nextlevel(){
//   document.getElementById("gk-question-div1").hidden = true;
//   document.getElementById("gk-question-div2").hidden = false;
// }
...
//   gk_result += gk_l2_result;

//   if (gk_l2_result < 3) {
//     document.getElementById("gk_level2_nextlevel").disabled = true;
//     document.getElementById("gk_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + gk_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + gk_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
//   }
//   if (gk_l2_result >= 3) {
//     document.getElementById("gk_level2_nextlevel").disabled = false;
//     document.getElementById("gk_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + gk_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + gk_result + "</b> out of 21. You passed the level. You can go to the next level.";
//   }
// }

// function gk_level2_reset(){
//   for (let i = 1; i <= 21; i++) {
//     for (let j = 1; j <= 4; j++) {
//       document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
//     }
//   };
//   document.getElementById("gk_level2_result").innerHTML = " ";
//   document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
//   document.getElementById("gk_level2_nextlevel").disabled = true;
//   gk_result -= gk_l2_result;
//   gk_l2_result = 0;;
...
// function gk_level2_save(){

// }

// function gk_level2_nextlevel(){
//   document.getElementById("gk-question-div2").hidden = true;
//   document.getElementById("gk-question-div3").hidden = false;
// }
...
document.getElementById("reasoning_level2_nextlevel").disabled = true;

let reasoning_result = 0;
...
function reasoning_level1_submit(){
  ...
  reasoning_result = reasoning_l1_result;

  if (reasoning_l1_result < 3) {
    document.getElementById("reasoning_level1_nextlevel").disabled = true;
    document.getElementById("reasoning_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
  }
  if (reasoning_l1_result >= 3) {
    document.getElementById("reasoning_level1_nextlevel").disabled = false;
    document.getElementById("reasoning_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You passed the level. You can go to the next level.";
  }
}

function reasoning_level1_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
      document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
  };
  document.getElementById("reasoning_level1_result").innerHTML = " ";
  document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
  document.getElementById("reasoning_level1_nextlevel").disabled = true;
  reasoning_l1_result = 0;
  reasoning_result = 0;
...
function reasoning_level1_save(){

}

function reasoning_level1_nextlevel(){
  document.getElementById("reasoning-question-div1").hidden = true;
  document.getElementById("reasoning-question-div2").hidden = false;
}
...
function reasoning_level2_submit(){
  ...
  reasoning_result += reasoning_l2_result;

  if (reasoning_l2_result < 3) {
    document.getElementById("reasoning_level2_nextlevel").disabled = true;
    document.getElementById("reasoning_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
  }
  if (reasoning_l2_result >= 3) {
    document.getElementById("reasoning_level2_nextlevel").disabled = false;
    document.getElementById("reasoning_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You passed the level. You can go to the next level.";
  }
}

function reasoning_level2_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
      document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
  };
  document.getElementById("reasoning_level2_result").innerHTML = " ";
  document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
  document.getElementById("reasoning_level2_nextlevel").disabled = true;
  reasoning_result -= reasoning_l2_result;
  reasoning_l2_result = 0;;
...
function reasoning_level2_save(){

}

function reasoning_level2_nextlevel(){
  document.getElementById("reasoning-question-div2").hidden = true;
  document.getElementById("reasoning-question-div3").hidden = false;
}
...
function reasoning_level3_submit(){
  ...
  if (reasoning_l3_result < 3) {
    document.getElementById("reasoning_level3_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l3_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
  }
  if (reasoning_l3_result >= 3) {
    document.getElementById("reasoning_level3_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + reasoning_l3_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + reasoning_result + "</b> out of 21. You passed the level. You can go to the next level.";
  }
}

function reasoning_level3_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
      document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
...
function reasoning_level3_save(){
