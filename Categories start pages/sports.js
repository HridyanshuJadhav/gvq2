...
function sports_level1_submit() {
  ...
  if (sports_l1_result < 3) {
    document.getElementById("sports_level1_nextlevel").disabled = true;
    document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_l1_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
   }
   if (sports_l1_result >= 3) {
      document.getElementById("sports_level1_nextlevel").disabled = false;
     document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_l1_result + "out of 7. You passed the level. You can go to the next level.";
...
function sports_level2_reset() {
  ...
  document.getElementById("sports_level2_result").innerHTML = " ";
  document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
  document.getElementById("sports_level2_nextlevel").disabled = true;
  sports_result -= sports_l2_result;
  sports_l1_result = 0;
...
function sports_level3_submit() {
  ...
  sports_result += sports_l3_result;
  if (sports_l3_result < 3) {
    document.getElementById("sports_level3_nextlevel").disabled = true;
     document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_l3_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
   }
   if (sports_l3_result >= 3) {
    document.getElementById("sports_level3_nextlevel").disabled = false;
     document.getElementById("sports_level1_result").innerHTML = "Your score is "+ sports_l3_result + "out of 7. You passed the level. You can go to the next level.";
   }
  
}
function sports_level3_reset() {
  for (let i = 1; i <= 20; i++) {
    for (let j = 1; j <= 4; j++) {
    document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
