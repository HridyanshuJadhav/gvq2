...
function business_and_economy_level1_submit() {
  ...
  if (business_and_economy_result < 3) {
    document.getElementById("business_and_economy_level1_nextlevel").disabled = true;
    document.getElementById("business_and_economy_level1_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
  }
  if (business_and_economy_result >= 3) {
    document.getElementById("business_and_economy_level1_nextlevel").disabled = false;
    document.getElementById("business_and_economy_level1_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You passed the level. You can go to the next level.";
  }
...
function business_and_economy_level2_submit() {
  ...
  if (business_and_economy_result < 3) {
    document.getElementById("business_and_economy_level2_nextlevel").disabled = true;
    document.getElementById("business_and_economy_level2_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
  }
  if (business_and_economy_result >= 3) {
    document.getElementById("business_and_economy_level2_nextlevel").disabled = false;
    document.getElementById("business_and_economy_level2_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You passed the level. You can go to the next level.";
  }
}
...
function business_and_economy_level3_submit() {
  ...
  if (business_and_economy_result < 3) {
    document.getElementById("business_and_economy_level2_nextlevel").disabled = true;
    document.getElementById("business_and_economy_level3_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
  }
  if (business_and_economy_result >= 3) {
    document.getElementById("business_and_economy_level2_nextlevel").disabled = false;
    document.getElementById("business_and_economy_level3_result").innerHTML = "Your score is "+ business_and_economy_result + "out of 7. You passed the level. You can go to the next level.";
  }
