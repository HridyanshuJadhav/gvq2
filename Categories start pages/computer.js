document.getElementById("computer-question-div2").hidden = true;
document.getElementById("computer-question-div3").hidden = true;

document.getElementById("computer_level1_nextlevel").disabled = true;
document.getElementById("computer_level2_nextlevel").disabled = true;
...
function computer_level1_submit(){
  ...
  computer_result = computer_l1_result;

  if (computer_l1_result < 3) {
    document.getElementById("computer_level1_nextlevel").disabled = true;
    document.getElementById("computer_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + computer_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + computer_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
  }
  if (computer_l1_result >= 3) {
    document.getElementById("computer_level1_nextlevel").disabled = false;
    document.getElementById("computer_level1_result").innerHTML = "Your score of level 1 is <b style='text-shadow:0 0 20px black;'>" + computer_l1_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + computer_result + "</b> out of 21. You passed the level. You can go to the next level.";
  }
}

function computer_level1_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
...
function computer_level1_save(){

}

function computer_level1_nextlevel(){
  document.getElementById("computer-question-div1").hidden = true;
  document.getElementById("computer-question-div2").hidden = false;
}
...
function computer_level2_submit(){
  ...
  computer_result += computer_l2_result;

  if (computer_l2_result < 3) {
    document.getElementById("computer_level2_nextlevel").disabled = true;
    document.getElementById("computer_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + computer_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + computer_result + "</b> out of 21. You failed the level. You can't go to the next level. Please try again.";
  }
  if (computer_l2_result >= 3) {
    document.getElementById("computer_level2_nextlevel").disabled = false;
    document.getElementById("computer_level2_result").innerHTML = "Your score of level 2 is <b style='text-shadow:0 0 20px black;'>" + computer_l2_result + "</b> out of 7 and your total score is <b style='text-shadow:0 0 20px black;'>" + computer_result + "</b> out of 21. You passed the level. You can go to the next level.";
  }
}

function computer_level2_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
      document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
  };
  document.getElementById("computer_level2_result").innerHTML = " ";
  document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
  document.getElementById("computer_level2_nextlevel").disabled = true;
  computer_result -= computer_l2_result;
  computer_l2_result = 0;;
...
function computer_level2_save(){

}

function computer_level2_nextlevel(){
  document.getElementById("computer-question-div2").hidden = true;
  document.getElementById("computer-question-div3").hidden = false;
}
...
function computer_level3_reset(){
  for (let i = 1; i <= 21; i++) {
    for (let j = 1; j <= 4; j++) {
      document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
