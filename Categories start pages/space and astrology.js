 ...
 document.getElementById("space_and_astrology-question-div2").hidden = true;
 document.getElementById("space_and_astrology-question-div3").hidden = true;
 ...
 function space_and_astrology_level1_submit() { 
  let space_and_astrology_result=0;
  let q1 = document.querySelector('input[name= q1]:checked');
  if ( q1 ==  q1_1) {
    space_and_astrology_result += 0;
  ...
  if (space_and_astrology_result < 3) {
   document.getElementById("space_and_astrology_level1_nextlevel").disabled = true;
   document.getElementById("space_and_astrology_level1_result").innerHTML = "Your score is "+ space_and_astrology_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
  }
  if (space_and_astrology_result >= 3) {
     document.getElementById("space_and_astrology_level1_nextlevel").disabled = false;
    document.getElementById("space_and_astrology_level1_result").innerHTML = "Your score is "+ space_and_astrology_result + "out of 7. You passed the level. You can go to the next level.";
 ...
 function space_and_astrology_level1_reset() {
   ...
   document.getElementById("space_and_astrology_level1_result").innerHTML = " ";
   document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
   document.getElementById("space_and_astrology_level1_nextlevel").disabled = true;
 }
 
 function space_and_astrology_level1_nextlevel() {
   document.getElementById("space_and_astrology-question-div1").hidden = true;
   document.getElementById("space_and_astrology-question-div2").hidden = false;
 }
 
 function space_and_astrology_level2_submit() {
   let space_and_astrology_result=0;
  ...
  if ( q10 ==  q10_1) {
   ...
   if (space_and_astrology_result < 3) {
     document.getElementById("space_and_astrology_level2_nextlevel").disabled = true;
     document.getElementById("space_and_astrology_level2_result").innerHTML = "Your score is "+ space_and_astrology_result + "out of 7. You failed the level. You can't go to the next level. Please try again.";
   }
  if (space_and_astrology_result >= 3) {
     document.getElementById("space_and_astrology_level2_nextlevel").disabled = false;
     document.getElementById("space_and_astrology_level2_result").innerHTML = "Your score is "+ space_and_astrology_result + "out of 7. You passed the level. You can go to the next level.";
   }
  
 }

 function space_and_astrology_level2_reset() {
  for (let i = 1; i <= 20; i++) {
    for (let j = 1; j <= 4; j++) {
    document.getElementById("q" + i + "_" + j + "_p").innerHTML = " ";
    }
 };
  document.getElementById("space_and_astrology_level2_result").innerHTML = " ";
  document.querySelectorAll('input[type=radio]:checked').forEach(radio => radio.checked = false);
  document.getElementById("space_and_astrology_level2_nextlevel").disabled = true;
}

function space_and_astrology_level2_nextlevel() {
  document.getElementById("space_and_astrology-question-div2").hidden = true;
  document.getElementById("space_and_astrology-question-div3").hidden = false;
}

 function space_and_astrology_level3_submit() {
  let space_and_astrology_result=0;
